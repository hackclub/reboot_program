...
class Api::V1::ProjectsController < ApplicationController
  ...
  before_action :set_project, only: [:show, :update, :destroy, :request_review]
  ...
  def request_review
    unless @project.can_request_review?
      render json: { error: "Project cannot be submitted for review" }, status: :unprocessable_entity
      return
    end
  ...
  def project_params
    params.require(:project).permit(:name, :description, :code_url, :playable_url, :screenshot_url, :hours)
  end
