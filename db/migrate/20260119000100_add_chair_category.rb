class AddChairCategory < ActiveRecord::Migration[8.0]
  def up
    execute <<-SQL.squish
      ...
      VALUES (
        ...
        'active',
        'This provides a $95 HCB card grant to spend on Chair',
        NOW(),
        NOW()
      )
  ...
  def down
    execute "DELETE FROM shop_items WHERE category = 'Chair' AND variant_key = 'zunmos_gaming_chair'"
  end
end
